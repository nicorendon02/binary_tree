...
import com.binary_tree.binary_tree.model.AVLTree;
...
public class AVLTreeService {
    ...
    public ResponseEntity<ResponseBinaryTreeDto> addNode(Boy boy) throws BinaryTreeException
    {
    ...
    {
        return new ResponseEntity<>(new ResponseBinaryTreeDto(avlTree.listBoys(which),
